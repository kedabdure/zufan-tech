              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                <Link
                  ...
                  className={cn(
                    ...
                    "group rounded-full border border-black/10 bg-neutral-100 px-5 py-1.5 text-base font-medium text-neutral-900 transition-all duration-300 hover:shadow-lg hover:bg-neutral-200 dark:border-white/10 dark:bg-neutral-900 dark:text-white dark:hover:bg-neutral-800 dark:hover:shadow-white/10",
